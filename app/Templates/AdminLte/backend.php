...
<head>
    ...
    Assets::css(array(
        // Bootstrap 3.3.7
        template_url('css/bootstrap.min.css', 'AdminLte'),
        // Font Awesome
    ...
    Assets::js(array(
      template_url('js/jquery-3.3.1.min.js', 'AdminLte'),
      // Bootstrap 4.6.2
      template_url('js/bootstrap.bundle.min.js', 'AdminLte'),
      // AdminLTE App
      template_url('dist/js/adminlte.min.js', 'AdminLte'),
  ));
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li <?php if($baseUri == 'admin/tickets') { echo 'class="active"'; } ?>>
                <a href="<?= site_url('admin/tickets'); ?>"><i class="fa fa-ticket"></i> <span><?= __d('admin_lte', 'Tickets'); ?></span> </a>
            </li>

            <?php if ($user->role_id < 4) { ?>
            <li <?php if($baseUri == 'admin/decisions') { echo 'class="active"'; } ?>>
                <a href="<?= site_url('admin/decisions'); ?>"><i class="fa fa-gavel"></i> <span><?= __d('admin_lte', 'Decisions'); ?></span> </a>
            </li>
            <?php } ?>
            <?php if ($user->role_id < 4) { ?>
            <li <?php if($baseUri == 'admin/categories') { echo 'class="active"'; } ?>>
                <a href="<?= site_url('admin/categories'); ?>"><i class="fa fa-th-list"></i> <span><?= __d('admin_lte', 'Categories'); ?></span> </a>
            </li>
            <?php } ?>
            <?php if ($user->role_id < 5) { ?>
            <li <?php if($baseUri == 'admin/replays') { echo 'class="active"'; } ?>>
                <a href="<?= site_url('admin/replays'); ?>"><i class="fa fa-file-video-o"></i> <span><?= __d('admin_lte', 'Replays'); ?></span> </a>
            </li>
            <?php } ?>
            <?php if ($user->role_id < 6) { ?>
            <li <?php if($baseUri == 'admin/wiki') { echo 'class="active"'; } ?>>
                <a href="<?= site_url('admin/wiki'); ?>"><i class="fa fa-wikipedia-w"></i> <span><?= __d('admin_lte', 'Wiki'); ?></span> </a>
            </li>
            <?php } ?>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="//kongor.online/" target="_blank"><b>Kongor.Online <?= VERSION; ?></b></a> - </strong> All rights reserved.
  </footer>
